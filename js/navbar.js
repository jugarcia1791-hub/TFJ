document.addEventListener('DOMContentLoaded', function() {
    ...
    const navConfig = [
        ...
        { id: 'galeria', href: "TFJ/views/galeria.html", icon: '🖼️', text: 'Galería' },
        { id: 'presupuesto', href: "TFJ/views/presupuesto.html", icon: '💰', text: 'Presupuesto' },
        { id: 'contacto', href: "TFJ/views/contacto.html", icon: '📞', text: 'Contacto' }
    ];
